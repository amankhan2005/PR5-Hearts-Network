      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border-t-4 border-green-400 hover:shadow-xl transition-shadow">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-green-100 rounded-xl flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <a href={HOSPITAL_MAP_LINK} target="_blank" rel="noopener noreferrer">
                    <p className="text-green-500 font-semibold mt-2">{HOSPITAL_ADDRESS}</p>
                  </a>
                  <p className="mt-2"></p>
                </div>
              </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full rounded-lg border-2 px-4 py-3 transition-all focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent ${
                          errors.parentName
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full rounded-lg border-2 border-gray-200 px-4 py-3 transition-all focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent hover:border-green-300"
                      >
                ...
                <div className="pt-4 border-t border-gray-200">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={5}
                      className={`w-full rounded-lg border-2 px-4 py-3 transition-all focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent resize-none ${
                        errors.message
                          ? "border-red-400 bg-red-50"
                          : "border-gray-200 hover:border-green-300"
                      }`}
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <div className="flex gap-3 w-full sm:w-auto">
                      ...
                      <button
                        ...
                        disabled={loading}
                        className="flex-1 sm:flex-none px-8 py-3 rounded-lg bg-gradient-to-r from-green-500 to-green-600 text-white font-semibold shadow-lg hover:shadow-xl hover:from-green-600 hover:to-green-700 disabled:opacity-60 disabled:cursor-not-allowed transition-all transform hover:scale-105 active:scale-95"
                      >
                        {loading ? (
